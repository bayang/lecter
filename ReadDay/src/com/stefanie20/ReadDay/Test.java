...
public class Test {
    ...
    public static void main(String[] args) throws Exception{
        ...
        URL streamContentURL = new URL("https://www.inoreader.com/reader/api/0/stream/contents/user/-/label/IT?xt=user/-/state/com.google/read");
        ...
        URL markReadURL = new URL("https://www.inoreader.com/reader/api/0/mark-all-as-read?s=user/1005907486/label/IT&ts=" + LocalDateTime.of(2016, 2, 19, 10, 0).toInstant(ZoneOffset.ofHours(8)).getEpochSecond());

//        getInfo(subscriptionListURL);
